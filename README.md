...
| :--- | :--- | :--- | :--- |
| **🐙 GitHub Repository** | [https://github.com/Magesh-03-K/RAG_DOCUMENT](https://github.com/Magesh-03-K/RAG_DOCUMENT) | `Main Branch (Up to date)` | Complete source code, Docker configs, and setup scripts |
